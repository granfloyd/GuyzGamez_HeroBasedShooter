...
public class Aerial : HeroBase
{
    ...
    {
        //HeroBase player = PlayerController.Player;
        //GameObject spawnedPrimaryFire = Instantiate(heroAbilityPrefabs[0],
    ...
    {
        //HeroBase player = PlayerController.Player;
        //GameObject spawnedAbility2 = Instantiate(heroAbilityPrefabs[1],
        //    PlayerController.Player.primaryFireSpawnPos.position,
        //    PlayerController.Player.orientation.localRotation);
        //Rigidbody rb = spawnedAbility2.GetComponent<Rigidbody>();
        //rb.velocity = tempGunAngle * 50f;
    }
